...
const UntitledLogoMinimal = (props: HTMLAttributes<HTMLOrSVGElement>) => {
  ...
  return (
    <div
      {...props}
      className={cx('relative h-8 w-8', props.className)}>
      <div className='absolute inset-x-[0.2px] bottom-0 top-0 z-10 flex -translate-y-[3.5%] items-end overflow-hidden rounded-[24%]'>
