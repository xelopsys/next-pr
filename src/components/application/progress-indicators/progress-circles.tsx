...
const sizes = sortCx({
    xxs: {
        strokeWidth: 6,
        radius: 29,
        valueClass: "text-primary tt-sm-semi",
        labelClass: "text-tertiary tt-xs-md",
        halfCircleTextPosition: "absolute bottom-0.5 text-center",
    },
    xs: {
        strokeWidth: 16,
        radius: 72,
        valueClass: "text-primary td-xs-semi",
        labelClass: "text-tertiary tt-xs-md",
        halfCircleTextPosition: "absolute bottom-0.5 text-center",
    },
    sm: {
        strokeWidth: 20,
        radius: 90,
        valueClass: "text-primary td-sm-semi",
        labelClass: "text-tertiary tt-xs-md",
    ...
    md: {
        strokeWidth: 24,
        radius: 108,
        valueClass: "text-primary td-md-semi",
        labelClass: "text-tertiary tt-sm-md",
        halfCircleTextPosition: "absolute bottom-1 text-center",
    },
    lg: {
        strokeWidth: 28,
        radius: 126,
        valueClass: "text-primary td-lg-semi",
        labelClass: "text-tertiary tt-sm-md",
