...
const theme: Config["theme"] = {
    ...
    fontFamily: {
        ...
        manrope: [`Manrope, -apple-system, "Segoe UI", system-ui, Roboto, Arial, sans-serif`],
    ...
    boxShadow: ({ theme }) => {
        ...
        shadows["xs-border-disabled-subtle"] = `${shadows["xs"]}, 0px 0px 0px 1px ${theme("borderColor")["disabled_subtle"]} inset`;

        shadows["xs-skeumorphic"] = `${shadows["skeumorphic"]}, ${shadows["xs"]}`;

        shadows["xs-skeumorphic-secondary-color"] =
            `0px 0px 0px 1px ${theme("colors").button["secondary"]["color"]["border"]} inset, 0px -2px 0px 0px rgba(16, 24, 40, 0.05) inset, ${shadows["xs"]}`;
        shadows["xs-skeumorphic-secondary-error"] =
            `0px 0px 0px 1px ${theme("colors").button["secondary"]["error"]["border"]} inset, 0px -2px 0px 0px rgba(16, 24, 40, 0.05) inset, ${shadows["xs"]}`;
        return shadows;
    },
    dropShadow: {
